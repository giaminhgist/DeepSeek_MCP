...
## Evidence
- `path/to/file.ts:10-42` — why it matters
- ...
...
- macOS
- Linux
- Windows where Node.js and Claude Code support the stdio MCP configuration

Use Node path APIs. Do not assume `/bin/bash`.
