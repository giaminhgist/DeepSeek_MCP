...
## 0. DeepSeek_MCP Uses Python

When working on the DeepSeek_MCP project described by these specifications:
...
- do not migrate the server to TypeScript/JavaScript/Node.js unless the user explicitly changes the project requirement.

Claude Code itself may have its own runtime/install requirements. Those do not change DeepSeek_MCP's Python implementation language.
